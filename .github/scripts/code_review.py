...
def main():
    ...
    prompt = (
        ...
        "If there are any logical errors or bugs then also consider them as the breaking_changes flag.\n"
        "If there are print or console.log statements added for debugging, then consider them as breaking_changes.\n"
        "If there are any changes in the environment variables, then consider them as breaking_changes.\n"
        "If there is a partial breaking change which requires documentation changes then allow it.\n"
        "If there is any change which contains backward compatibility then allow it.\n"
