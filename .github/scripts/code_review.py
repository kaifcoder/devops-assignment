...
def main():
    ...
    prompt = (
        ...
        "If there are any Syntax error or logical errors or Bugs consider them as the breaking_changes flag.\n"
        "If there are print or console.log statements added for debugging consider them as breaking_changes.\n"
        "If there is a partial breaking change which don't crashes the application and requires documentation changes then allow it.\n"
